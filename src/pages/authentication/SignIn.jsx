...
const SignIn = () => {
  ...
  const handleSignIn = async (values, resetForm) => {
    ...
    try {
      ...
      alert(error.message.includes('invalid-credential') ? 'Invalid Email or Password.' : 'An error occurred. Please try again.');
            ...
            <SectionRight>
              ...
              {({ errors, values, handleChange }) => (
                <Form>
                  ...
                  <Field>
                    <Link onClick={() => navigate('/passwordreset')}>Forgot Password</Link>
                    <Text style={{ marginTop: "0.5rem" }}>Don't have an account? <Link style={{ color: colors.accent2 }} onClick={() => navigate('/signup')}>Sign Up</Link></Text>
                  </Field>
                </Form>
              )}
              </Formik>
